...
responses = {
    "yes": ["Do one time, do swee swee", "Do what you want, just don't get caught."],
    "no": ["Gennerman, wake up your idea.", "Mai lai lah", "Wear helmet then cannot think is it?"],
    "maybe": ["Don't make your problem my problem", "By right, cannot. By left, can."]
}
